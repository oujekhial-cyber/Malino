...
Item{ColumnLayout{anchors.fill:parent;anchors.margins:18;layoutDirection:Qt.RightToLeft;spacing:12
    ...
    TextArea{id:sms;placeholderText:"آخرین پیامک بانک را اینجا قرار بده...";Layout.fillWidth:true;height:140;wrapMode:TextArea.Wrap;horizontalAlignment:Text.AlignRight}
